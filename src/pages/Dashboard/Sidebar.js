...
const Sidebar = () => {
    ...
    const dataButtons = [
        { 
            ...
            activeLink: "https://img.icons8.com/ios/500/FFFFFF/windows-11.png"
        },
        { 
            id: 2, 
            text: "Appointment", 
            link: "https://img.icons8.com/ios/500/555962/planner.png",
            activeLink: "https://img.icons8.com/ios/500/FFFFFF/planner.png"
        },
        { 
            id: 3, 
            text: "My Patients", 
            link: "https://img.icons8.com/parakeet-line/500/555962/user.png",
            activeLink: "https://img.icons8.com/parakeet-line/500/FFFFFF/user.png"
        },
        { 
            id: 4, 
            text: "Schedule Timings", 
            link: "https://img.icons8.com/pastel-glyph/500/555962/clock--v1.png",
            activeLink: "https://img.icons8.com/pastel-glyph/500/FFFFFF/clock--v1.png"
        },
        { 
            id: 5, 
            text: "Payments", 
            link: "https://img.icons8.com/ios/500/555962/bank-card-back-side--v1.png",
            activeLink: "https://img.icons8.com/ios/500/FFFFFF/bank-card-back-side--v1.png"
        },
        {
            id: 6, 
            text: "Message", 
            link: "https://img.icons8.com/ios/500/555962/new-post.png",
            activeLink: "https://img.icons8.com/ios/500/FFFFFF/new-post.png"
        },
        {
            id: 7, 
            text: "Blog", 
            link: "https://img.icons8.com/ios/500/555962/document--v1.png",
            activeLink: "https://img.icons8.com/ios/500/FFFFFF/document--v1.png"
        },
        {
            id: 8, 
            text: "Settings", 
            link: "https://img.icons8.com/ios/500/555962/settings--v1.png",
            activeLink: "https://img.icons8.com/ios/500/FFFFFF/settings--v1.png"
        },
    ...
    const toggleActive = (index) => {
        ...
        if (index === 2) navigate("/mypatients");
    };
