...
var addSeconds = require('date-fns-jalali/addSeconds');
var addMinutes = require('date-fns-jalali/addMinutes');
var addHours = require('date-fns-jalali/addHours');
var addDays = require('date-fns-jalali/addDays');
var addWeeks = require('date-fns-jalali/addWeeks');
var addMonths = require('date-fns-jalali/addMonths');
var addYears = require('date-fns-jalali/addYears');
var differenceInYears = require('date-fns-jalali/differenceInYears');
var differenceInQuarters = require('date-fns-jalali/differenceInQuarters');
var differenceInMonths = require('date-fns-jalali/differenceInMonths');
var differenceInWeeks = require('date-fns-jalali/differenceInWeeks');
var differenceInDays = require('date-fns-jalali/differenceInDays');
var differenceInHours = require('date-fns-jalali/differenceInHours');
var differenceInMinutes = require('date-fns-jalali/differenceInMinutes');
var differenceInSeconds = require('date-fns-jalali/differenceInSeconds');
var differenceInMilliseconds = require('date-fns-jalali/differenceInMilliseconds');
var eachDayOfInterval = require('date-fns-jalali/eachDayOfInterval');
var endOfDay = require('date-fns-jalali/endOfDay');
var endOfWeek = require('date-fns-jalali/endOfWeek');
var endOfYear = require('date-fns-jalali/endOfYear');
var format = require('date-fns-jalali/format');
var formatISO = require('date-fns-jalali/formatISO');
var getHours = require('date-fns-jalali/getHours');
var getSeconds = require('date-fns-jalali/getSeconds');
var getYear = require('date-fns-jalali/getYear');
var getMonth = require('date-fns-jalali/getMonth');
var getDay = require('date-fns-jalali/getDay');
var getDaysInMonth = require('date-fns-jalali/getDaysInMonth');
var getMinutes = require('date-fns-jalali/getMinutes');
var isAfter = require('date-fns-jalali/isAfter');
var isBefore = require('date-fns-jalali/isBefore');
var isEqual = require('date-fns-jalali/isEqual');
var isSameDay = require('date-fns-jalali/isSameDay');
var isSameYear = require('date-fns-jalali/isSameYear');
var isSameMonth = require('date-fns-jalali/isSameMonth');
var isSameHour = require('date-fns-jalali/isSameHour');
var isValid = require('date-fns-jalali/isValid');
var dateFnsParse = require('date-fns-jalali/parse');
var parseISO = require('date-fns-jalali/parseISO');
var setHours = require('date-fns-jalali/setHours');
var setMinutes = require('date-fns-jalali/setMinutes');
var setMonth = require('date-fns-jalali/setMonth');
var setSeconds = require('date-fns-jalali/setSeconds');
var setYear = require('date-fns-jalali/setYear');
var startOfDay = require('date-fns-jalali/startOfDay');
var startOfMonth = require('date-fns-jalali/startOfMonth');
var endOfMonth = require('date-fns-jalali/endOfMonth');
var startOfWeek = require('date-fns-jalali/startOfWeek');
var startOfYear = require('date-fns-jalali/startOfYear');
var isWithinInterval = require('date-fns-jalali/isWithinInterval');
var longFormatters = require('date-fns-jalali/_lib/format/longFormatters');
var defaultLocale = require('date-fns-jalali/locale/fa-IR');
