...
`,ni=X.div`
  ...
  `};
`,oi={1:"1.85714em",2:"1.57143em",3:"1.27em"},ii=e=>H`
...
`),ci=X.h5`
  ...
  ${K("UnderlinedHeader")};
`,pi=(0,e.createContext)(void 0),{Provider:ui,Consumer:di}=pi;function hi(t){const{spec:r,specUrl:n,options:o,onLoaded:i,children:s}=t,[a,l]=e.useState(null),[c,p]=e.useState(null);if(c)throw c;e.useEffect((()=>{!function(){return e=this,null,t=function*(){if(r||n){l(null);try{const e=yield me(r||n);l(e)}catch(e){throw p(e),e}}},new Promise(((r,n)=>{var o=e=>{try{s(t.next(e))}catch(e){n(e)}},i=e=>{try{s(t.throw(e))}catch(e){n(e)}},s=e=>e.done?r(e.value):Promise.resolve(e.value).then(o,i);s((t=t.apply(e,null)).next())}));var e,t}()}),[r,n]);const u=e.useMemo((()=>{if(!a)return null;try{return new Tl(a,n,o)}catch(e){throw i&&i(e),e}}),[a,n,o]);return e.useEffect((()=>{u&&i&&i()}),[u,i]),s({loading:!u,store:u})}const mi=e=>H`
  ${e} {
    cursor: pointer;
    margin-left: -20px;
    padding: 0;
...
`;function fi(t){const r=e.useContext(pi),n=e.useCallback((e=>{r&&function(e,t,r){t.defaultPrevented||0!==t.button||(e=>!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey))(t)||(t.preventDefault(),e.replace(encodeURI(r)))}(r.menu.history,e,t.to)}),[r,t.to]);return r?e.createElement("a",{className:t.className,href:r.menu.history.linkForId(t.to),onClick:n,"aria-label":t.to},t.children):null}const gi=X(fi)`
  ${mi("&")};
`;function yi(t){return e.createElement(gi,{to:t.to})}const bi={left:"90deg",right:"-90deg",up:"-180deg",down:"0"};class xi extends e.PureComponent{render(){return e.createElement("svg",{className:this.props.className,style:this.props.style,version:"1.1",viewBox:"0 0 24 24",x:"0",xmlns:"http://www.w3.org/2000/svg",y:"0","aria-hidden":"true"},e.createElement("polygon",{points:"17.3 8.3 12 13.6 6.7 8.3 5.3 9.7 12 16.4 18.7 9.7 "}))}}const vi=X(xi)`
  height: ${e=>e.size||"18px"};
  width: ${e=>e.size||"18px"};
  vertical-align: middle;
  float: ${e=>e.float||""};
  transition: transform 0.2s ease-out;
  transform: rotateZ(${e=>bi[e.direction||"down"]});
...
`;var Di=require("react-tabs");const zi=X(Di.Tabs)`
  > ul {
    list-style: none;
    padding: 0;
    margin: 0;
...
`;var Bi=require("perfect-scrollbar"),Qi=r.n(Bi),Ui=Object.defineProperty,Wi=Object.getOwnPropertySymbols,Vi=Object.prototype.hasOwnProperty,Hi=Object.prototype.propertyIsEnumerable,Ji=(e,t,r)=>t in e?Ui(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const Yi=Qi()||Bi;let Zi="";s&&(Zi=r(433),Zi="function"==typeof Zi.toString&&Zi.toString()||"",Zi="[object Object]"===Zi?"":Zi);const Gi=J`${Zi}`,Xi=X.div`
  position: relative;
`;class Ki extends e.Component{constructor(){super(...arguments),this.handleRef=e=>{this._container=e}}componentDidMount(){const e=this._container.parentElement&&this._container.parentElement.scrollTop||0;this.inst=new Yi(this._container,this.props.options||{}),this._container.scrollTo&&this._container.scrollTo(0,e)}componentDidUpdate(){this.inst.update()}componentWillUnmount(){this.inst.destroy()}render(){const{children:t,className:r,updateFn:n}=this.props;return n&&n(this.componentDidUpdate.bind(this)),e.createElement(e.Fragment,null,Zi&&e.createElement(Gi,null),e.createElement(Xi,{className:`scrollbar-container ${r}`,ref:this.handleRef},t))}}function es(t){return e.createElement(ae.Consumer,null,(r=>r.nativeScrollbars?e.createElement("div",{style:{overflow:"auto",overscrollBehavior:"contain",msOverflowStyle:"-ms-autohiding-scrollbar"}},t.children):e.createElement(Ki,((e,t)=>{for(var r in t||(t={}))Vi.call(t,r)&&Ji(e,r,t[r]);if(Wi)for(var r of Wi(t))Hi.call(t,r)&&Ji(e,r,t[r]);return e})({},t),t.children)))}const ts=X((({className:t,style:r})=>e.createElement("svg",{className:t,style:r,xmlns:"http://www.w3.org/2000/svg",width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},e.createElement("polyline",{points:"6 9 12 15 18 9"}))))`
  position: absolute;
  pointer-events: none;
  z-index: 1;
  top: 50%;
...
`,rs=e.memo((t=>{const{options:r,onChange:n,placeholder:o,value:i="",variant:s,className:a}=t;return e.createElement("div",{className:a},e.createElement(ts,{variant:s}),e.createElement("select",{onChange:e=>{const{selectedIndex:t}=e.target;n(r[o?t-1:t])},value:i,className:"dropdown-select"},o&&e.createElement("option",{disabled:!0,hidden:!0,value:o},o),r.map((({idx:t,value:r,title:n},o)=>e.createElement("option",{key:t||r+o,value:r},n||r)))),e.createElement("label",null,i))})),ns=W()(rs)`
  label {
    box-sizing: border-box;
    min-width: 100px;
    outline: none;
...
`,is=W().span`
  ...
  font-size: 0.929em;
  color: black;
`;var ss=Object.defineProperty,as=Object.getOwnPropertySymbols,ls=Object.prototype.hasOwnProperty,cs=Object.prototype.propertyIsEnumerable,ps=(e,t,r)=>t in e?ss(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;function us(t){const{Label:r=is,Dropdown:n=os}=t;return 1===t.options.length?e.createElement(r,null,t.options[0].value):e.createElement(n,((e,t)=>{for(var r in t||(t={}))ls.call(t,r)&&ps(e,r,t[r]);if(as)for(var r of as(t))cs.call(t,r)&&ps(e,r,t[r]);return e})({},t))}var ds=require("dompurify");const hs=H`
  a {
...
`,ms=X(Mi)`
  ...
  ${K("Markdown")};
`;var fs=Object.defineProperty,gs=Object.getOwnPropertySymbols,ys=Object.prototype.hasOwnProperty,bs=Object.prototype.propertyIsEnumerable,xs=(e,t,r)=>t in e?fs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const vs=ms.withComponent("span");function ws(t){const r=t.inline?vs:ms;return e.createElement(ce,null,(n=>{return e.createElement(r,((e,t)=>{for(var r in t||(t={}))ys.call(t,r)&&xs(e,r,t[r]);if(gs)for(var r of gs(t))bs.call(t,r)&&xs(e,r,t[r]);return e})({className:"redoc-markdown "+(t.className||""),dangerouslySetInnerHTML:{__html:(o=n.untrustedSpec,i=t.html,o?ds.sanitize(i):i)},"data-role":t["data-role"]},t));var o,i}))}class ks extends e.Component{render(){const{source:t,inline:r,compact:n,className:o,"data-role":i}=this.props,s=new qr;return e.createElement(ws,{html:s.renderMd(t),inline:r,compact:n,className:o,"data-role":i})}}const Os=X.div`
  position: relative;
`,Es=X.div`
  position: absolute;
  min-width: 80px;
...
`,Rs=X.div`
  ...
  height: 20px;
  bottom: -20px;
`;class js extends e.Component{render(){const{open:t,title:r,children:n}=this.props;return e.createElement(Os,null,n,t&&e.createElement(Es,null,e.createElement(Ss,null,r),e.createElement($s,null),e.createElement(Rs,null)))}}const Cs="undefined"!=typeof document&&document.queryCommandSupported&&document.queryCommandSupported("copy");class As{static isSupported(){return Cs}static selectElement(e){let t,r;document.body.createTextRange?(t=document.body.createTextRange(),t.moveToElementText(e),t.select()):document.createRange&&window.getSelection&&(r=window.getSelection(),t=document.createRange(),t.selectNodeContents(e),r.removeAllRanges(),r.addRange(t))}static deselect(){if(document.selection)document.selection.empty();else if(window.getSelection){const e=window.getSelection();e&&e.removeAllRanges()}}static copySelected(){let e;try{e=document.execCommand("copy")}catch(t){e=!1}return e}static copyElement(e){As.selectElement(e);const t=As.copySelected();return t&&As.deselect(),t}static copyCustom(e){const t=document.createElement("textarea");t.style.position="fixed",t.style.top="0",t.style.left="0",t.style.width="2em",t.style.height="2em",t.style.padding="0",t.style.border="none",t.style.outline="none",t.style.boxShadow="none",t.style.background="transparent",t.value=e,document.body.appendChild(t),t.select();const r=As.copySelected();return document.body.removeChild(t),r}}class Ps extends e.PureComponent{constructor(t){super(t),this.copy=()=>{const e="string"==typeof this.props.data?this.props.data:JSON.stringify(this.props.data,null,2);As.copyCustom(e),this.showTooltip()},this.renderCopyButton=()=>e.createElement("button",{onClick:this.copy},e.createElement(js,{title:As.isSupported()?"Copied":"Not supported in your browser",open:this.state.tooltipShown},"Copy")),this.state={tooltipShown:!1}}render(){return this.props.children({renderCopyButton:this.renderCopyButton})}showTooltip(){this.setState({tooltipShown:!0}),setTimeout((()=>{this.setState({tooltipShown:!1})}),1500)}}let Is=1;function Ts(e,t){Is=1;let r="";return r+='<div class="redoc-json">',r+="<code>",r+=Ms(e,t),r+="</code>",r+="</div>",r}function _s(e){return void 0!==e?e.toString().replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function Ls(e){return JSON.stringify(e).slice(1,-1)}function Ds(e,t){return'<span class="'+t+'">'+_s(e)+"</span>"}function zs(e){return'<span class="token punctuation">'+e+"</span>"}function Ms(e,t){const r=typeof e;let n="";return null==e?n+=Ds("null","token keyword"):e&&e.constructor===Array?(Is++,n+=function(e,t){const r=Is>t?"collapsed":"";let n=`<button class="collapser" aria-label="${Is>t+1?"expand":"collapse"}"></button>${zs("[")}<span class="ellipsis"></span><ul class="array collapsible">`,o=!1;const i=e.length;for(let s=0;s<i;s++)o=!0,n+='<li><div class="hoverable '+r+'">',n+=Ms(e[s],t),s<i-1&&(n+=","),n+="</div></li>";return n+=`</ul>${zs("]")}`,o||(n=zs("[ ]")),n}(e,t),Is--):e&&e.constructor===Date?n+=Ds('"'+e.toISOString()+'"',"token string"):"object"===r?(Is++,n+=function(e,t){const r=Is>t?"collapsed":"",n=Object.keys(e),o=n.length;let i=`<button class="collapser" aria-label="${Is>t+1?"expand":"collapse"}"></button>${zs("{")}<span class="ellipsis"></span><ul class="obj collapsible">`,s=!1;for(let a=0;a<o;a++){const l=n[a];s=!0,i+='<li><div class="hoverable '+r+'">',i+='<span class="property token string">"'+_s(l)+'"</span>: ',i+=Ms(e[l],t),a<o-1&&(i+=zs(",")),i+="</div></li>"}return i+=`</ul>${zs("}")}`,s||(i=zs("{ }")),i}(e,t),Is--):"number"===r?n+=Ds(e,"token number"):"string"===r?/^(http|https):\/\/[^\s]+$/.test(e)?n+=Ds('"',"token string")+'<a href="'+encodeURI(e)+'">'+_s(Ls(e))+"</a>"+Ds('"',"token string"):n+=Ds('"'+Ls(e)+'"',"token string"):"boolean"===r&&(n+=Ds(e,"token boolean")),n}const Ns=H`
...
`;class Fs extends e.PureComponent{constructor(){super(...arguments),this.renderInner=({renderCopyButton:t})=>{const r=this.props.data&&Object.values(this.props.data).some((e=>"object"==typeof e&&null!==e));return e.createElement(qs,null,e.createElement(Ni,null,t(),r&&e.createElement(e.Fragment,null,e.createElement("button",{onClick:this.expandAll}," Expand all "),e.createElement("button",{onClick:this.collapseAll}," Collapse all "))),e.createElement(ae.Consumer,null,(t=>e.createElement(Mi,{className:this.props.className,ref:e=>this.node=e,dangerouslySetInnerHTML:{__html:Ts(this.props.data,t.jsonSampleExpandLevel)}}))))},this.expandAll=()=>{const e=this.node.getElementsByClassName("collapsible");for(const t of Array.prototype.slice.call(e)){const e=t.parentNode;e.classList.remove("collapsed"),e.querySelector(".collapser").setAttribute("aria-label","collapse")}},this.collapseAll=()=>{const e=this.node.getElementsByClassName("collapsible"),t=Array.prototype.slice.call(e,1);for(const e of t){const t=e.parentNode;t.classList.add("collapsed"),t.querySelector(".collapser").setAttribute("aria-label","expand")}},this.collapseElement=e=>{let t;"collapser"===e.className&&(t=e.parentElement.getElementsByClassName("collapsible")[0],t.parentElement.classList.contains("collapsed")?(t.parentElement.classList.remove("collapsed"),e.setAttribute("aria-label","collapse")):(t.parentElement.classList.add("collapsed"),e.setAttribute("aria-label","expand")))},this.clickListener=e=>{this.collapseElement(e.target)},this.focusListener=e=>{"Enter"===e.key&&this.collapseElement(e.target)}}render(){return e.createElement(Ps,{data:this.props.data},this.renderInner)}componentDidMount(){this.node.addEventListener("click",this.clickListener),this.node.addEventListener("focus",this.focusListener)}componentWillUnmount(){this.node.removeEventListener("click",this.clickListener),this.node.removeEventListener("focus",this.focusListener)}}const Bs=X(Fs)`
  ${Ns};
`;class Qs extends e.PureComponent{render(){const{source:t,lang:r}=this.props;return e.createElement(Fi,{dangerouslySetInnerHTML:{__html:wt(t,r)}})}}class Us extends e.Component{render(){return e.createElement(Ps,{data:this.props.source},(({renderCopyButton:t})=>e.createElement(qi,null,e.createElement(Ni,null,t()),e.createElement(Qs,{lang:this.props.lang,source:this.props.source}))))}}function Ws({value:t,mimeType:r}){return Fe(r)?e.createElement(Bs,{data:t}):("object"==typeof t&&(t=JSON.stringify(t,null,2)),e.createElement(Us,{lang:Ze(r),source:t}))}function Vs({example:t,mimeType:r}){return void 0===t.value&&t.externalValueUrl?e.createElement(Hs,{example:t,mimeType:r}):e.createElement(Ws,{value:t.value,mimeType:r})}function Hs({example:t,mimeType:r}){const n=function(t,r){const[,n]=(0,e.useState)(!0),o=(0,e.useRef)(void 0),i=(0,e.useRef)(void 0);return i.current!==t&&(o.current=void 0),i.current=t,(0,e.useEffect)((()=>{(()=>{return e=this,i=function*(){n(!0);try{o.current=yield t.getExternalValue(r)}catch(e){o.current=e}n(!1)},new Promise(((t,r)=>{var n=e=>{try{s(i.next(e))}catch(e){r(e)}},o=e=>{try{s(i.throw(e))}catch(e){r(e)}},s=e=>e.done?t(e.value):Promise.resolve(e.value).then(n,o);s((i=i.apply(e,null)).next())}));var e,i})()}),[t,r]),o.current}(t,r);return void 0===n?e.createElement("span",null,"Loading..."):n instanceof Error?e.createElement(Fi,null,"Error loading external example: ",e.createElement("br",null),e.createElement("a",{className:"token string",href:t.externalValueUrl,target:"_blank",rel:"noopener noreferrer"},t.externalValueUrl)):e.createElement(Ws,{value:n,mimeType:r})}const Js=X.div`
  padding: 0.9em;
...
`,Xs=X.div`
  ...
  font-size: 12px;
  color: #ee807f;
`;class Ks extends e.Component{constructor(){super(...arguments),this.state={activeIdx:0},this.switchMedia=({idx:e})=>{void 0!==e&&this.setState({activeIdx:e})}}render(){const{activeIdx:t}=this.state,r=this.props.mediaType.examples||{},n=this.props.mediaType.name,o=e.createElement(Xs,null,"No sample"),i=Object.keys(r);if(0===i.length)return o;if(i.length>1){const o=i.map(((e,t)=>({value:r[e].summary||e,idx:t}))),s=r[i[t]],a=s.description;return e.createElement(ea,null,e.createElement(Zs,null,e.createElement(Ys,null,"Example"),this.props.renderDropdown({value:o[t].value,options:o,onChange:this.switchMedia,ariaLabel:"Example"})),e.createElement("div",null,a&&e.createElement(ks,{source:a}),e.createElement(Vs,{example:s,mimeType:n})))}{const t=r[i[0]];return e.createElement(ea,null,t.description&&e.createElement(ks,{source:t.description}),e.createElement(Vs,{example:t,mimeType:n}))}}}const ea=X.div`
  margin-top: 15px;
`;var ta=require("mobx-react");const ra=X($i)`
  button {
    background-color: transparent;
    border: 0;
    outline: 0;
...
`,sa=X(na)`
  ...
  word-break: break-word;
`,aa=ia,la=X(na.withComponent("div"))`
...
`,ma=X.button`
  ...
  font-size: 12px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;const fa=X.div`
  ${hs};
  ${({compact:e})=>e?"":"margin: 1em 0"}
`;let ga=class extends e.Component{render(){const{externalDocs:t}=this.props;return t&&t.url?e.createElement(fa,{compact:this.props.compact},e.createElement("a",{href:t.url},t.description||t.url)):null}};ga=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],ga);class ya extends e.PureComponent{constructor(){super(...arguments),this.state={collapsed:!0}}toggle(){this.setState({collapsed:!this.state.collapsed})}render(){const{values:t,isArrayType:r}=this.props,{collapsed:n}=this.state,{enumSkipQuotes:o,maxDisplayedEnumValues:i}=this.context;if(!t.length)return null;const s=this.state.collapsed&&i?t.slice(0,i):t,a=!!i&&t.length>i,l=i?n?`… ${t.length-i} more`:"Hide":"";return e.createElement("div",null,e.createElement(na,null,r?P("enumArray"):""," ",1===t.length?P("enumSingleValue"):P("enum"),":")," ",s.map(((t,r)=>{const n=o?String(t):JSON.stringify(t);return e.createElement(e.Fragment,{key:r},e.createElement(ua,null,n)," ")})),a?e.createElement(ba,{onClick:()=>{this.toggle()}},l):null)}}ya.contextType=ae;const ba=X.span`
  color: ${e=>e.theme.colors.primary.main};
  vertical-align: middle;
  font-size: 13px;
  line-height: 20px;
...
`,xa=X(ms)`
  margin: 2px 0;
`;class va extends e.PureComponent{render(){const t=this.props.extensions;return e.createElement(ae.Consumer,null,(r=>e.createElement(e.Fragment,null,r.showExtensions&&Object.keys(t).map((r=>e.createElement(xa,{key:r},e.createElement(na,null," ",r.substring(2),": ")," ",e.createElement(da,null,"string"==typeof t[r]?t[r]:JSON.stringify(t[r]))))))))}}function wa({field:t}){return t.examples?e.createElement(e.Fragment,null,e.createElement(na,null," ",P("examples"),": "),C(t.examples)?t.examples.map(((r,n)=>{const o=Ye(t,r),i=t.in?String(o):JSON.stringify(o);return e.createElement(e.Fragment,{key:n},e.createElement(ua,null,i)," ")})):e.createElement(ka,null,Object.values(t.examples).map(((r,n)=>e.createElement("li",{key:n+r.value},e.createElement(ua,null,Ye(t,r.value))," -"," ",r.summary||r.description))))):null}const ka=X.ul`
  margin-top: 1em;
  list-style-position: outside;
`;class Oa extends e.PureComponent{render(){return 0===this.props.constraints.length?null:e.createElement("span",null," ",this.props.constraints.map((t=>e.createElement(ha,{key:t}," ",t," "))))}}const Ea=e.memo((function({value:t,label:r,raw:n}){if(void 0===t)return null;const o=n?String(t):JSON.stringify(t);return e.createElement("div",null,e.createElement(na,null," ",r," ")," ",e.createElement(ua,null,o))}));function Sa(t){const r=t.schema.pattern,{hideSchemaPattern:n}=e.useContext(ae),[o,i]=e.useState(!1),s=e.useCallback((()=>i(!o)),[o]);return!r||n?null:e.createElement(e.Fragment,null,e.createElement(pa,null,o||r.length<45?r:`${r.substr(0,45)}...`),r.length>45&&e.createElement(ma,{onClick:s},o?"Hide pattern":"Show pattern"))}function $a({schema:t}){return!t||"string"===t.type&&!t.constraints.length?null:e.createElement(Ra,null,"[ items",t.displayFormat&&e.createElement(aa,null," <",t.displayFormat," >"),e.createElement(Oa,{constraints:t.constraints}),e.createElement(Sa,{schema:t}),t.items&&e.createElement($a,{schema:t.items})," ]")}const Ra=X(oa)`
  margin: 0 5px;
  vertical-align: text-top;
`;var ja=Object.defineProperty,Ca=Object.getOwnPropertySymbols,Aa=Object.prototype.hasOwnProperty,Pa=Object.prototype.propertyIsEnumerable,Ia=(e,t,r)=>t in e?ja(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Ta=(e,t)=>{for(var r in t||(t={}))Aa.call(t,r)&&Ia(e,r,t[r]);if(Ca)for(var r of Ca(t))Pa.call(t,r)&&Ia(e,r,t[r]);return e};const _a=e.memo((function(t){const{enumSkipQuotes:r,hideSchemaTitles:n}=e.useContext(ae),{showExamples:o,field:i,renderDiscriminatorSwitch:s}=t,{schema:a,description:l,deprecated:c,extensions:p,in:u,const:d}=i,h="array"===a.type,m=r||"header"===u,f=e.useMemo((()=>!o||void 0===i.example&&void 0===i.examples?null:void 0!==i.examples?e.createElement(wa,{field:i}):e.createElement(Ea,{label:P("example")+":",value:Ye(i,i.example),raw:Boolean(i.in)})),[i,o]);return e.createElement("div",null,e.createElement("div",null,e.createElement(oa,null,a.typePrefix),e.createElement(ia,null,a.displayType),a.displayFormat&&e.createElement(aa,null," ","<",a.displayFormat,">"," "),a.contentEncoding&&e.createElement(aa,null," ","<",a.contentEncoding,">"," "),a.contentMediaType&&e.createElement(aa,null," ","<",a.contentMediaType,">"," "),a.title&&!n&&e.createElement(sa,null," (",a.title,") "),e.createElement(Oa,{constraints:a.constraints}),e.createElement(Sa,{schema:a}),a.isCircular&&e.createElement(ca,null," ",P("recursive")," "),h&&a.items&&e.createElement($a,{schema:a.items})),c&&e.createElement("div",null,e.createElement(wi,{type:"warning"}," ",P("deprecated")," ")),e.createElement(Ea,{raw:m,label:P("default")+":",value:a.default}),!s&&e.createElement(ya,{isArrayType:h,values:a.enum})," ",f,e.createElement(va,{extensions:Ta(Ta({},p),a.extensions)}),e.createElement("div",null,e.createElement(ks,{compact:!0,source:l})),a.externalDocs&&e.createElement(ga,{externalDocs:a.externalDocs,compact:!0}),s&&s(t)||null,d&&e.createElement(Ea,{label:P("const")+":",value:d})||null)}));var La=Object.defineProperty,Da=Object.defineProperties,za=Object.getOwnPropertyDescriptors,Ma=Object.getOwnPropertySymbols,Na=Object.prototype.hasOwnProperty,qa=Object.prototype.propertyIsEnumerable,Fa=(e,t,r)=>t in e?La(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const Ba=X.div`
  padding-left: ${({theme:e})=>2*e.spacing.unit}px;
`;class Qa extends e.PureComponent{render(){const t=this.props.schema,r=t.items,n=void 0===t.minItems&&void 0===t.maxItems?"":`(${rt(t)})`;return!t.displayType||r||n.length?e.createElement("div",null,e.createElement(_i,null," Array ",n),e.createElement(Ba,null,e.createElement(bl,(o=((e,t)=>{for(var r in t||(t={}))Na.call(t,r)&&Fa(e,r,t[r]);if(Ma)for(var r of Ma(t))qa.call(t,r)&&Fa(e,r,t[r]);return e})({},this.props),Da(o,za({schema:r}))))),e.createElement(Li,null)):e.createElement("div",null,e.createElement(ia,null,t.displayType));var o}}var Ua=Object.defineProperty,Wa=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),Va=Object.prototype.hasOwnProperty,Ha=Object.prototype.propertyIsEnumerable,Ja=(e,t,r)=>t in e?Ua(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let Ya=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{void 0===this.props.field.expanded&&this.props.expandByDefault?this.props.field.collapse():this.props.field.toggle()},this.handleKeyPress=e=>{"Enter"===e.key&&(e.preventDefault(),this.toggle())}}render(){const{className:t,field:r,isLast:n,expandByDefault:o}=this.props,{name:i,deprecated:s,required:a,kind:l}=r,c=!r.schema.isPrimitive&&!r.schema.isCircular,p=void 0===r.expanded?o:r.expanded,u=c?e.createElement(ra,{className:s?"deprecated":"",kind:l,title:i},e.createElement(ji,null),e.createElement("button",{onClick:this.toggle,onKeyPress:this.handleKeyPress,"aria-label":"expand properties"},e.createElement("span",null,i),e.createElement(vi,{direction:p?"down":"right"})),a&&e.createElement(la,null," required ")):e.createElement($i,{className:s?"deprecated":void 0,kind:l,title:i},e.createElement(ji,null),e.createElement("span",null,i),a&&e.createElement(la,null," required "));return e.createElement(e.Fragment,null,e.createElement("tr",{className:n?"last "+t:t},u,e.createElement(Ri,null,e.createElement(_a,((e,t)=>{for(var r in t||(t={}))Va.call(t,r)&&Ja(e,r,t[r]);if(Wa)for(var r of Wa(t))Ha.call(t,r)&&Ja(e,r,t[r]);return e})({},this.props)))),p&&c&&e.createElement("tr",{key:r.name+"inner"},e.createElement(Si,{colSpan:2},e.createElement(Ci,null,e.createElement(bl,{schema:r.schema,skipReadOnly:this.props.skipReadOnly,skipWriteOnly:this.props.skipWriteOnly,showTitle:this.props.showTitle,level:this.props.level})))))}};Ya=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],Ya);Object.defineProperty,Object.getOwnPropertyDescriptor;let Za=class extends e.Component{constructor(){super(...arguments),this.changeActiveChild=e=>{void 0!==e.idx&&this.props.parent.activateOneOf(e.idx)}}sortOptions(e,t){if(0===t.length)return;const r={};t.forEach(((e,t)=>{r[e]=t})),e.sort(((e,t)=>r[e.value]>r[t.value]?1:-1))}render(){const{parent:t,enumValues:r}=this.props;if(void 0===t.oneOf)return null;const n=t.oneOf.map(((e,t)=>({value:e.title,idx:t}))),o=n[t.activeOneOf].value;return this.sortOptions(n,r),e.createElement(ns,{value:o,options:n,onChange:this.changeActiveChild,ariaLabel:"Example"})}};Za=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],Za);const Ga=(0,ta.observer)((({schema:{fields:t=[],title:r},showTitle:n,discriminator:o,skipReadOnly:i,skipWriteOnly:s,level:a})=>{const{expandSingleSchemaField:l,showObjectSchemaExamples:c,schemaExpansionLevel:p}=e.useContext(ae),u=e.useMemo((()=>i||s?t.filter((e=>!(i&&e.schema.readOnly||s&&e.schema.writeOnly))):t),[i,s,t]),h=l&&1===u.length||p>=a;return e.createElement(Ai,null,n&&e.createElement(Oi,null,r),e.createElement("tbody",null,d(u,((t,r)=>e.createElement(Ya,{key:t.name,isLast:r,field:t,expandByDefault:h,renderDiscriminatorSwitch:(null==o?void 0:o.fieldName)===t.name?()=>e.createElement(Za,{parent:o.parentSchema,enumValues:t.schema.enum}):void 0,className:t.expanded?"expanded":void 0,showExamples:c,skipReadOnly:i,skipWriteOnly:s,showTitle:n,level:a})))))}));var Xa=Object.defineProperty,Ka=Object.defineProperties,el=Object.getOwnPropertyDescriptor,tl=Object.getOwnPropertyDescriptors,rl=Object.getOwnPropertySymbols,nl=Object.prototype.hasOwnProperty,ol=Object.prototype.propertyIsEnumerable,il=(e,t,r)=>t in e?Xa(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,sl=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?el(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&Xa(t,r,i),i};let al=class extends e.Component{constructor(){super(...arguments),this.activateOneOf=()=>{this.props.schema.activateOneOf(this.props.idx)}}render(){const{idx:t,schema:r,subSchema:n}=this.props;return e.createElement(Ti,{deprecated:n.deprecated,active:t===r.activeOneOf,onClick:this.activateOneOf},n.title||n.typePrefix+n.displayType)}};al=sl([ta.observer],al);let ll=class extends e.Component{render(){const{schema:{oneOf:t},schema:r}=this.props;return void 0===t?null:e.createElement("div",null,e.createElement(Ii,null," ",r.oneOfType," "),e.createElement(Pi,null,t.map(((t,n)=>e.createElement(al,{key:t.pointer,schema:r,subSchema:t,idx:n})))),e.createElement("div",null,t[r.activeOneOf].deprecated&&e.createElement(wi,{type:"warning"},"Deprecated")),e.createElement(bl,(n=((e,t)=>{for(var r in t||(t={}))nl.call(t,r)&&il(e,r,t[r]);if(rl)for(var r of rl(t))ol.call(t,r)&&il(e,r,t[r]);return e})({},this.props),o={schema:t[r.activeOneOf]},Ka(n,tl(o)))));var n,o}};ll=sl([ta.observer],ll);var cl=Object.defineProperty,pl=Object.defineProperties,ul=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),dl=Object.getOwnPropertySymbols,hl=Object.prototype.hasOwnProperty,ml=Object.prototype.propertyIsEnumerable,fl=(e,t,r)=>t in e?cl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,gl=(e,t)=>{for(var r in t||(t={}))hl.call(t,r)&&fl(e,r,t[r]);if(dl)for(var r of dl(t))ml.call(t,r)&&fl(e,r,t[r]);return e},yl=(e,t)=>pl(e,ul(t));let bl=class extends e.Component{render(){var t;const r=this.props,{schema:n}=r,o=((e,t)=>{var r={};for(var n in e)hl.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(null!=e&&dl)for(var n of dl(e))t.indexOf(n)<0&&ml.call(e,n)&&(r[n]=e[n]);return r})(r,["schema"]),i=(o.level||0)+1;if(!n)return e.createElement("em",null," Schema not provided ");const{type:s,oneOf:a,discriminatorProp:l,isCircular:c}=n;if(c)return e.createElement("div",null,e.createElement(ia,null,n.displayType),n.title&&e.createElement(sa,null," ",n.title," "),e.createElement(ca,null," ",P("recursive")," "));if(void 0!==l)return a&&a.length?e.createElement(Ga,yl(gl({},o),{level:i,schema:a[n.activeOneOf],discriminator:{fieldName:l,parentSchema:n}})):(console.warn(`Looks like you are using discriminator wrong: you don't have any definition inherited from the ${n.title}`),null);if(void 0!==a)return e.createElement(ll,gl({schema:n},o));const p=C(s)?s:[s];if(p.includes("object")){if(null==(t=n.fields)?void 0:t.length)return e.createElement(Ga,yl(gl({},this.props),{level:i}))}else if(p.includes("array"))return e.createElement(Qa,yl(gl({},this.props),{level:i}));const u={schema:n,name:"",required:!1,description:n.description,externalDocs:n.externalDocs,deprecated:!1,toggle:()=>null,expanded:!1};return e.createElement("div",null,e.createElement(_a,{field:u}))}};bl=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],bl);var xl=Object.defineProperty,vl=Object.defineProperties,wl=Object.getOwnPropertyDescriptors,kl=Object.getOwnPropertySymbols,Ol=Object.prototype.hasOwnProperty,El=Object.prototype.propertyIsEnumerable,Sl=(e,t,r)=>t in e?xl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class $l extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(us,(r=((e,t)=>{for(var r in t||(t={}))Ol.call(t,r)&&Sl(e,r,t[r]);if(kl)for(var r of kl(t))El.call(t,r)&&Sl(e,r,t[r]);return e})({Label:is,Dropdown:Gs},t),vl(r,wl({variant:"dark"}))));var r}}static getMediaType(e,t){if(!e)return{};const r={schema:{$ref:e}};return t&&(r.examples={example:{$ref:t}}),r}get mediaModel(){const{parser:e,schemaRef:t,exampleRef:r,options:n}=this.props;return this._mediaModel||(this._mediaModel=new Pn(e,"json",!1,$l.getMediaType(t,r),n)),this._mediaModel}render(){const{showReadOnly:t=!0,showWriteOnly:r=!1}=this.props;return e.createElement(ei,null,e.createElement(ni,null,e.createElement(Ko,null,e.createElement(bl,{skipWriteOnly:!r,skipReadOnly:!t,schema:this.mediaModel.schema})),e.createElement(ri,null,e.createElement(Rl,null,e.createElement(Ks,{renderDropdown:this.renderDropdown,mediaType:this.mediaModel})))))}}const Rl=X.div`
  background: ${({theme:e})=>e.codeBlock.backgroundColor};
  & > div,
  & > pre {
    padding: ${e=>4*e.theme.spacing.unit}px;
...
`,jl={oauth2:"OAuth2",apiKey:"API Key",http:"HTTP",openIdConnect:"OpenID Connect"};class Cl extends e.PureComponent{render(){const{type:t,flow:r}=this.props,n=Object.keys((null==r?void 0:r.scopes)||{});return e.createElement("tr",null,e.createElement("th",null," ",t," OAuth Flow "),e.createElement("td",null,"implicit"===t||"authorizationCode"===t?e.createElement("div",null,e.createElement("strong",null," Authorization URL: "),r.authorizationUrl):null,"password"===t||"clientCredentials"===t||"authorizationCode"===t?e.createElement("div",null,e.createElement("strong",null," Token URL: "),r.tokenUrl):null,r.refreshUrl&&e.createElement("div",null,e.createElement("strong",null," Refresh URL: "),r.refreshUrl),!!n.length&&e.createElement(e.Fragment,null,e.createElement("div",null,e.createElement("strong",null," Scopes: ")),e.createElement("ul",null,n.map((t=>e.createElement("li",{key:t},e.createElement("code",null,t)," -"," ",e.createElement(ks,{inline:!0,source:r.scopes[t]||""}))))))))}}class Al extends e.PureComponent{render(){return this.props.securitySchemes.schemes.map((t=>e.createElement(ei,{id:t.sectionId,key:t.id},e.createElement(ni,null,e.createElement(Ko,null,e.createElement(ai,null,e.createElement(yi,{to:t.sectionId}),t.displayName),e.createElement(ks,{source:t.description||""}),e.createElement(ms,null,e.createElement("table",{className:"security-details"},e.createElement("tbody",null,e.createElement("tr",null,e.createElement("th",null," Security Scheme Type "),e.createElement("td",null," ",jl[t.type]||t.type," ")),t.apiKey?e.createElement("tr",null,e.createElement("th",null," ",E(t.apiKey.in||"")," parameter name:"),e.createElement("td",null," ",t.apiKey.name," ")):t.http?[e.createElement("tr",{key:"scheme"},e.createElement("th",null," HTTP Authorization Scheme "),e.createElement("td",null," ",t.http.scheme," ")),"bearer"===t.http.scheme&&t.http.bearerFormat&&e.createElement("tr",{key:"bearer"},e.createElement("th",null," Bearer format "),e.createElement("td",null,' "',t.http.bearerFormat,'" '))]:t.openId?e.createElement("tr",null,e.createElement("th",null," Connect URL "),e.createElement("td",null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:t.openId.connectUrl},t.openId.connectUrl))):t.flows?Object.keys(t.flows).map((r=>e.createElement(Cl,{key:r,type:r,flow:t.flows[r]}))):null))))))))}}var Pl=(e,t,r)=>new Promise(((n,o)=>{var i=e=>{try{a(r.next(e))}catch(e){o(e)}},s=e=>{try{a(r.throw(e))}catch(e){o(e)}},a=e=>e.done?n(e.value):Promise.resolve(e.value).then(i,s);a((r=r.apply(e,t)).next())}));function Il(e,t){return Pl(this,arguments,(function*(e,t,r={}){const n=yield me(e||t);return new Tl(n,t,r)}))}class Tl{constructor(e,t,r={},n=!0){this.marker=new Qt,this.disposer=null,this.rawOptions=r,this.options=new Q(r,_l),this.scroll=new Go(this.options),Ho.updateOnHistory(Ft.currentId,this.scroll),this.spec=new Ro(e,t,this.options),this.menu=new Ho(this.spec,this.scroll,Ft),this.options.disableSearch||(this.search=new Xo,n&&this.search.indexItems(this.menu.items),this.disposer=(0,pe.observe)(this.menu,"activeItemIdx",(e=>{this.updateMarkOnMenu(e.newValue)})))}static fromJS(e){const t=new Tl(e.spec.data,e.spec.url,e.options,!1);return t.menu.activeItemIdx=e.menu.activeItemIdx||0,t.menu.activate(t.menu.flatItems[t.menu.activeItemIdx]),t.options.disableSearch||t.search.load(e.searchIndex),t}onDidMount(){this.menu.updateOnHistory(),this.updateMarkOnMenu(this.menu.activeItemIdx)}dispose(){this.scroll.dispose(),this.menu.dispose(),this.search&&this.search.dispose(),null!=this.disposer&&this.disposer()}toJS(){return Pl(this,null,(function*(){return{menu:{activeItemIdx:this.menu.activeItemIdx},spec:{url:this.spec.parser.specUrl,data:this.spec.parser.spec},searchIndex:this.search?yield this.search.toJS():void 0,options:this.rawOptions}}))}updateMarkOnMenu(e){const t=Math.max(0,e),r=Math.min(this.menu.flatItems.length,t+5),n=[];for(let e=t;e<r;e++){const t=this.menu.getElementAt(e);t&&n.push(t)}if(-1===e&&s){const e=document.querySelector('[data-role="redoc-description"]'),t=document.querySelector('[data-role="redoc-summary"]');e&&n.push(e),t&&n.push(t)}this.marker.addOnly(n),this.marker.mark()}}const _l={allowedMdComponents:{[ct]:{component:Al,propsSelector:e=>({securitySchemes:e.spec.securitySchemes})},[pt]:{component:Al,propsSelector:e=>({securitySchemes:e.spec.securitySchemes})},[ut]:{component:$l,propsSelector:e=>({parser:e.spec.parser,options:e.options})}}},Ll=X(si)`
  margin-top: 0;
  margin-bottom: 0.5em;
...
`,Nl=X.div`
  ...
  margin-left: -${15}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let ql=class extends e.Component{constructor(){super(...arguments),this.handleDownloadClick=e=>{e.target.href||(e.target.href=this.props.store.spec.info.downloadLink)}}render(){const{store:t}=this.props,{info:r,externalDocs:n}=t.spec,o=t.options.hideDownloadButton,i=r.downloadFileName,s=r.downloadLink,a=r.license&&e.createElement(zl,null,"License:"," ",r.license.identifier?r.license.identifier:e.createElement("a",{href:r.license.url},r.license.name))||null,l=r.contact&&r.contact.url&&e.createElement(zl,null,"URL: ",e.createElement("a",{href:r.contact.url},r.contact.url))||null,c=r.contact&&r.contact.email&&e.createElement(zl,null,r.contact.name||"E-mail",":"," ",e.createElement("a",{href:"mailto:"+r.contact.email},r.contact.email))||null,p=r.termsOfService&&e.createElement(zl,null,e.createElement("a",{href:r.termsOfService},"Terms of Service"))||null,u=r.version&&e.createElement("span",null,"(",r.version,")")||null;return e.createElement(ei,null,e.createElement(ni,null,e.createElement(Ko,{className:"api-info"},e.createElement(Ll,null,r.title," ",u),!o&&e.createElement("p",null,P("downloadSpecification"),":",e.createElement(Dl,{download:i||!0,target:"_blank",href:s,onClick:this.handleDownloadClick},P("download"))),e.createElement(ms,null,(r.license||r.contact||r.termsOfService)&&e.createElement(Ml,null,e.createElement(Nl,null,c," ",l," ",a," ",p))||null),e.createElement(ks,{source:t.spec.info.summary,"data-role":"redoc-summary"}),e.createElement(ks,{source:t.spec.info.description,"data-role":"redoc-description"}),n&&e.createElement(ga,{externalDocs:n}))))}};ql=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],ql);const Fl=X.img`
...
`,Ql=X.a`
  display: inline-block;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Ul=class extends e.Component{render(){const{info:t}=this.props,r=t["x-logo"];if(!r||!r.url)return null;const n=r.href||t.contact&&t.contact.url,o=r.altText?r.altText:"logo",i=e.createElement(Fl,{src:r.url,alt:o});return e.createElement(Bl,{style:{backgroundColor:r.backgroundColor}},n?(s=n,t=>e.createElement(Ql,{href:s},t))(i):i);var s}};Ul=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],Ul);var Wl=Object.defineProperty,Vl=Object.getOwnPropertySymbols,Hl=Object.prototype.hasOwnProperty,Jl=Object.prototype.propertyIsEnumerable,Yl=(e,t,r)=>t in e?Wl(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Zl=(e,t)=>{for(var r in t||(t={}))Hl.call(t,r)&&Yl(e,r,t[r]);if(Vl)for(var r of Vl(t))Jl.call(t,r)&&Yl(e,r,t[r]);return e};class Gl extends e.Component{render(){return e.createElement(ce,null,(t=>e.createElement(di,null,(e=>this.renderWithOptionsAndStore(t,e)))))}renderWithOptionsAndStore(t,r){const{source:n,htmlWrap:o=(e=>e)}=this.props;if(!r)throw new Error("When using components in markdown, store prop must be provided");const i=new qr(t).renderMdWithComponents(n);return i.length?i.map(((t,n)=>"string"==typeof t?e.cloneElement(o(e.createElement(ws,{html:t,inline:!1,compact:!1})),{key:n}):e.createElement(t.component,Zl({key:n},Zl(Zl({},t.props),t.propsSelector(r)))))):null}}var Xl=require("classnames"),Kl=r.n(Xl);const ec=X.span.attrs((e=>({className:`operation-type ${e.type}`})))`
  width: 9ex;
  display: inline-block;
...
`;function tc(e,{theme:t},r){return e>1?t.sidebar.level1Items[r]:1===e?t.sidebar.groupItems[r]:""}const rc=X.ul`
  margin: 0;
  padding: 0;
...
`,oc={0:H`
  ...
  `},ic=X.label.attrs((e=>({role:"menuitem",className:Kl()("-depth"+e.depth,{active:e.active})})))`
  cursor: pointer;
...
`;class lc extends e.PureComponent{render(){const{name:t,opened:r,className:n,onClick:o,httpVerb:i,deprecated:s}=this.props;return e.createElement(cc,{className:n,onClick:o||void 0},e.createElement(uc,{type:i},mt(i)),e.createElement(vi,{size:"1.5em",direction:r?"down":"right",float:"left"}),e.createElement(pc,{deprecated:s},t),s?e.createElement(wi,{type:"warning"}," ",P("deprecated")," "):null)}}const cc=X.button`
  border: 0;
  width: 100%;
  text-align: left;
  & > * {
...
`,hc=X.div`
  ...
  margin-bottom: 5px;
  margin-top: 5px;
`;class mc extends e.PureComponent{constructor(){super(...arguments),this.selectElement=()=>{As.selectElement(this.child)}}render(){const{children:t}=this.props;return e.createElement("div",{ref:e=>this.child=e,onClick:this.selectElement,onFocus:this.selectElement,tabIndex:0,role:"button"},t)}}const fc=X.div`
  cursor: pointer;
  position: relative;
  margin-bottom: 5px;
`,gc=X.span`
...
`,bc=X.span.attrs((e=>({className:`http-verb ${e.type}`})))`
...
`;class kc extends e.Component{constructor(e){super(e),this.toggle=()=>{this.setState({expanded:!this.state.expanded})},this.state={expanded:!1}}render(){const{operation:t,inverted:r,hideHostname:n}=this.props,{expanded:o}=this.state;return e.createElement(ae.Consumer,null,(i=>e.createElement(fc,null,e.createElement(yc,{onClick:this.toggle,expanded:o,inverted:r},e.createElement(bc,{type:t.httpVerb,compact:this.props.compact},t.httpVerb),e.createElement(gc,null,t.path),e.createElement(vi,{float:"right",color:r?"black":"white",size:"20px",direction:o?"up":"down",style:{marginRight:"-25px"}})),e.createElement(xc,{expanded:o,"aria-hidden":!o},t.servers.map((r=>{const o=i.expandDefaultServerVariables?at(r.url,r.variables):r.url,s=O(o);return e.createElement(vc,{key:o},e.createElement(ks,{source:r.description||"",compact:!0}),e.createElement(mc,null,e.createElement(wc,null,e.createElement("span",null,n||i.hideHostname?"/"===s?"":s:o),t.path)))}))))))}}class Oc extends e.PureComponent{render(){const{place:t,parameters:r}=this.props;return r&&r.length?e.createElement("div",{key:t},e.createElement(ci,null,t," Parameters"),e.createElement(Ai,null,e.createElement("tbody",null,d(r,((t,r)=>e.createElement(Ya,{key:t.name,isLast:r,field:t,showExamples:!0})))))):null}}Object.defineProperty,Object.getOwnPropertyDescriptor;let Ec=class extends e.Component{constructor(){super(...arguments),this.switchMedia=({idx:e})=>{this.props.content&&void 0!==e&&this.props.content.activate(e)}}render(){const{content:t}=this.props;if(!t||!t.mediaTypes||!t.mediaTypes.length)return null;const r=t.activeMimeIdx,n=t.mediaTypes.map(((e,t)=>({value:e.name,idx:t}))),o=({children:t})=>this.props.withLabel?e.createElement(Zs,null,e.createElement(Ys,null,"Content type"),t):t;return e.createElement(e.Fragment,null,e.createElement(o,null,this.props.renderDropdown({value:n[r].value,options:n,onChange:this.switchMedia,ariaLabel:"Content type"})),this.props.children(t.active))}};Ec=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],Ec);var Sc=Object.defineProperty,$c=Object.getOwnPropertySymbols,Rc=Object.prototype.hasOwnProperty,jc=Object.prototype.propertyIsEnumerable,Cc=(e,t,r)=>t in e?Sc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const Ac=["path","query","cookie","header"];class Pc extends e.PureComponent{orderParams(e){const t={};return e.forEach((e=>{var r,n,o;o=e,(r=t)[n=e.in]||(r[n]=[]),r[n].push(o)})),t}render(){const{body:t,parameters:r=[]}=this.props;if(void 0===t&&void 0===r)return null;const n=this.orderParams(r),o=r.length>0?Ac:[],i=t&&t.content,s=t&&t.description;return e.createElement(e.Fragment,null,o.map((t=>e.createElement(Oc,{key:t,place:t,parameters:n[t]}))),i&&e.createElement(Tc,{content:i,description:s}))}}function Ic(t){return e.createElement(ci,{key:"header"},"Request Body schema: ",e.createElement(us,((e,t)=>{for(var r in t||(t={}))Rc.call(t,r)&&Cc(e,r,t[r]);if($c)for(var r of $c(t))jc.call(t,r)&&Cc(e,r,t[r]);return e})({},t)))}function Tc(t){const{content:r,description:n}=t,{isRequestType:o}=r;return e.createElement(Ec,{content:r,renderDropdown:Ic},(({schema:t})=>e.createElement(e.Fragment,null,void 0!==n&&e.createElement(ks,{source:n}),e.createElement(bl,{skipReadOnly:o,skipWriteOnly:!o,key:"schema",schema:t}))))}const _c=e.memo((function({title:t,type:r,empty:n,code:o,opened:i,className:s,onClick:a}){return e.createElement("button",{className:s,onClick:!n&&a||void 0,"aria-expanded":i,disabled:n},!n&&e.createElement(vi,{size:"1.5em",color:r,direction:i?"down":"right",float:"left"}),e.createElement(Mc,null,o," "),e.createElement(ks,{compact:!0,inline:!0,source:t}))})),Lc=X(_c)`
  display: block;
  border: 0;
  width: 100%;
  text-align: left;
...
`,Dc=X.div`
  padding: 10px;
`,zc=X(ci.withComponent("caption"))`
  text-align: left;
  margin-top: 1em;
  caption-side: top;
`,Mc=X.strong`
  vertical-align: top;
`;class Nc extends e.PureComponent{render(){const{headers:t}=this.props;return void 0===t||0===t.length?null:e.createElement(Ai,null,e.createElement(zc,null," Response Headers "),e.createElement("tbody",null,d(t,((t,r)=>e.createElement(Ya,{isLast:r,key:t.name,field:t,showExamples:!0})))))}}var qc=Object.defineProperty,Fc=Object.getOwnPropertySymbols,Bc=Object.prototype.hasOwnProperty,Qc=Object.prototype.propertyIsEnumerable,Uc=(e,t,r)=>t in e?qc(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;class Wc extends e.PureComponent{constructor(){super(...arguments),this.renderDropdown=t=>e.createElement(ci,{key:"header"},"Response Schema: ",e.createElement(us,((e,t)=>{for(var r in t||(t={}))Bc.call(t,r)&&Uc(e,r,t[r]);if(Fc)for(var r of Fc(t))Qc.call(t,r)&&Uc(e,r,t[r]);return e})({},t)))}render(){const{description:t,extensions:r,headers:n,content:o}=this.props.response;return e.createElement(e.Fragment,null,t&&e.createElement(ks,{source:t}),e.createElement(va,{extensions:r}),e.createElement(Nc,{headers:n}),e.createElement(Ec,{content:o,renderDropdown:this.renderDropdown},(({schema:t})=>e.createElement(bl,{skipWriteOnly:!0,key:"schema",schema:t}))))}}const Vc=(0,ta.observer)((({response:t})=>{const{extensions:r,headers:n,type:o,summary:i,description:s,code:a,expanded:l,content:c}=t,p=e.useMemo((()=>void 0===c?[]:c.mediaTypes.filter((e=>void 0!==e.schema))),[c]),u=e.useMemo((()=>!(r&&0!==Object.keys(r).length||0!==n.length||0!==p.length||s)),[r,n,p,s]);return e.createElement("div",null,e.createElement(Lc,{onClick:()=>t.toggle(),type:o,empty:u,title:i||"",code:a,opened:l}),l&&!u&&e.createElement(Dc,null,e.createElement(Wc,{response:t})))})),Hc=X.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;class Jc extends e.PureComponent{render(){const{responses:t,isCallback:r}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(Hc,null,P(r?"callbackResponses":"responses")),t.map((t=>e.createElement(Vc,{key:t.code,response:t})))):null}}const Yc=X.ul`
  display: inline;
  list-style: none;
  padding: 0;
...
`,Xc=X.span`
  ...
  ${hs};
`;class Kc extends e.PureComponent{render(){const t=this.props.security;return e.createElement(Xc,null,t.schemes.length?t.schemes.map((t=>e.createElement(Gc,{key:t.id},e.createElement(fi,{to:t.sectionId},t.displayName),t.scopes.length>0&&" (",e.createElement(Yc,null,t.scopes.map((t=>e.createElement("li",{key:t},e.createElement(Zc,null,t))))),t.scopes.length>0&&") "))):e.createElement(Gc,null,"None"))}}const ep=X.div`
  flex: 1 1 auto;
`,tp=X.div`
  width: ${e=>e.theme.schema.defaultDetailsWidth};
  ${G.lessThan("small")`
...
`,np=X.div`
  ...
  ${G.lessThan("small")`
    flex-direction: column;
  `}
`;class op extends e.PureComponent{render(){const t=this.props.securities;return t.length?e.createElement(np,null,e.createElement(ep,null,e.createElement(rp,null,"Authorizations: ")),e.createElement(tp,null,t.map(((t,r)=>e.createElement(Kc,{key:r,security:t}))))):null}}Object.defineProperty,Object.getOwnPropertyDescriptor;let ip=class extends e.Component{render(){const{operation:t}=this.props,{description:r,externalDocs:n}=t,o=!(!r&&!n);return e.createElement(hc,null,o&&e.createElement(sp,null,void 0!==r&&e.createElement(ks,{source:r}),n&&e.createElement(ga,{externalDocs:n})),e.createElement(kc,{operation:this.props.operation,inverted:!0,compact:!0}),e.createElement(va,{extensions:t.extensions}),e.createElement(op,{securities:t.security}),e.createElement(Pc,{parameters:t.parameters,body:t.requestBody}),e.createElement(Jc,{responses:t.responses,isCallback:t.isCallback}))}};ip=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],ip);const sp=X.div`
  margin-bottom: ${({theme:e})=>3*e.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let ap=class extends e.Component{constructor(){super(...arguments),this.toggle=()=>{this.props.callbackOperation.toggle()}}render(){const{name:t,expanded:r,httpVerb:n,deprecated:o}=this.props.callbackOperation;return e.createElement(e.Fragment,null,e.createElement(dc,{onClick:this.toggle,name:t,opened:r,httpVerb:n,deprecated:o}),r&&e.createElement(ip,{operation:this.props.callbackOperation}))}};ap=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],ap);class lp extends e.PureComponent{render(){const{callbacks:t}=this.props;return t&&0!==t.length?e.createElement("div",null,e.createElement(cp,null," Callbacks "),t.map((t=>t.operations.map(((r,n)=>e.createElement(ap,{key:`${t.name}_${n}`,callbackOperation:r})))))):null}}const cp=X.h3`
  font-size: 1.3em;
  padding: 0.2em 0;
  margin: 3em 0 1.1em;
  color: ${({theme:e})=>e.colors.text.primary};
  font-weight: normal;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let pp=class extends e.Component{constructor(e){super(e),this.switchItem=({idx:e})=>{this.props.items&&void 0!==e&&this.setState({activeItemIdx:e})},this.state={activeItemIdx:0}}render(){const{items:t}=this.props;if(!t||!t.length)return null;const r=({children:t})=>this.props.label?e.createElement(Zs,null,e.createElement(Ys,null,this.props.label),t):t;return e.createElement(e.Fragment,null,e.createElement(r,null,this.props.renderDropdown({value:this.props.options[this.state.activeItemIdx].value,options:this.props.options,onChange:this.switchItem,ariaLabel:this.props.label||"Callback"})),this.props.children(t[this.state.activeItemIdx]))}};pp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],pp);var up=Object.defineProperty,dp=Object.defineProperties,hp=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),mp=Object.getOwnPropertySymbols,fp=Object.prototype.hasOwnProperty,gp=Object.prototype.propertyIsEnumerable,yp=(e,t,r)=>t in e?up(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let bp=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(us,(r=((e,t)=>{for(var r in t||(t={}))fp.call(t,r)&&yp(e,r,t[r]);if(mp)for(var r of mp(t))gp.call(t,r)&&yp(e,r,t[r]);return e})({Label:Js,Dropdown:Gs},t),dp(r,hp({variant:"dark"}))));var r}}render(){const t=this.props.content;return void 0===t?null:e.createElement(Ec,{content:t,renderDropdown:this.renderDropdown,withLabel:!0},(t=>e.createElement(Ks,{key:"samples",mediaType:t,renderDropdown:this.renderDropdown})))}};bp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],bp);class xp extends e.Component{render(){const t=this.props.callback.codeSamples.find((e=>Zn(e)));return t?e.createElement(vp,null,e.createElement(bp,{content:t.requestBodyContent})):null}}const vp=X.div`
  margin-top: 15px;
`;var wp=Object.defineProperty,kp=Object.defineProperties,Op=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),Ep=Object.getOwnPropertySymbols,Sp=Object.prototype.hasOwnProperty,$p=Object.prototype.propertyIsEnumerable,Rp=(e,t,r)=>t in e?wp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let jp=class extends e.Component{constructor(){super(...arguments),this.renderDropdown=t=>{return e.createElement(us,(r=((e,t)=>{for(var r in t||(t={}))Sp.call(t,r)&&Rp(e,r,t[r]);if(Ep)for(var r of Ep(t))$p.call(t,r)&&Rp(e,r,t[r]);return e})({Label:Js,Dropdown:Gs},t),kp(r,Op({variant:"dark"}))));var r}}render(){const{callbacks:t}=this.props;if(!t||0===t.length)return null;const r=t.map((e=>e.operations.map((e=>e)))).reduce(((e,t)=>e.concat(t)),[]);if(!r.some((e=>e.codeSamples.length>0)))return null;const n=r.map(((e,t)=>({value:`${e.httpVerb.toUpperCase()}: ${e.name}`,idx:t})));return e.createElement("div",null,e.createElement(li,null," Callback payload samples "),e.createElement(Cp,null,e.createElement(pp,{items:r,renderDropdown:this.renderDropdown,label:"Callback",options:n},(t=>e.createElement(xp,{key:"callbackPayloadSample",callback:t,renderDropdown:this.renderDropdown})))))}};jp.contextType=ae,jp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],jp);const Cp=X.div`
  background: ${({theme:e})=>e.codeBlock.backgroundColor};
  padding: ${e=>4*e.theme.spacing.unit}px;
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let Ap=class extends e.Component{render(){const{operation:t}=this.props,r=t.codeSamples,n=r.length>0,o=1===r.length&&this.context.hideSingleRequestSampleTab;return n&&e.createElement("div",null,e.createElement(li,null," ",P("requestSamples")," "),e.createElement(zi,{defaultIndex:0},e.createElement(Di.TabList,{hidden:o},r.map((t=>e.createElement(Di.Tab,{key:t.lang+"_"+(t.label||"")},void 0!==t.label?t.label:t.lang)))),r.map((t=>e.createElement(Di.TabPanel,{key:t.lang+"_"+(t.label||"")},Zn(t)?e.createElement("div",null,e.createElement(bp,{content:t.requestBodyContent})):e.createElement(Us,{lang:t.lang,source:t.source}))))))||null}};Ap.contextType=ae,Ap=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],Ap);Object.defineProperty,Object.getOwnPropertyDescriptor;let Pp=class extends e.Component{render(){const{operation:t}=this.props,r=t.responses.filter((e=>e.content&&e.content.hasSample));return r.length>0&&e.createElement("div",null,e.createElement(li,null," ",P("responseSamples")," "),e.createElement(zi,{defaultIndex:0},e.createElement(Di.TabList,null,r.map((t=>e.createElement(Di.Tab,{className:"tab-"+t.type,key:t.code},t.code)))),r.map((t=>e.createElement(Di.TabPanel,{key:t.code},e.createElement("div",null,e.createElement(bp,{content:t.content})))))))||null}};Pp=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],Pp);var Ip=Object.defineProperty,Tp=Object.defineProperties,_p=Object.getOwnPropertyDescriptors,Lp=Object.getOwnPropertySymbols,Dp=Object.prototype.hasOwnProperty,zp=Object.prototype.propertyIsEnumerable,Mp=(e,t,r)=>t in e?Ip(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;const Np=X.div`
  margin-bottom: ${({theme:e})=>6*e.spacing.unit}px;
`,qp=(0,ta.observer)((({operation:t})=>{const{name:r,description:n,deprecated:o,externalDocs:i,isWebhook:s,httpVerb:a}=t,l=!(!n&&!i),{showWebhookVerb:c}=e.useContext(ae);return e.createElement(ae.Consumer,null,(p=>{return e.createElement(ni,(u=((e,t)=>{for(var r in t||(t={}))Dp.call(t,r)&&Mp(e,r,t[r]);if(Lp)for(var r of Lp(t))zp.call(t,r)&&Mp(e,r,t[r]);return e})({},{[Vo]:t.operationHash}),d={id:t.operationHash},Tp(u,_p(d))),e.createElement(Ko,null,e.createElement(ai,null,e.createElement(yi,{to:t.id}),r," ",o&&e.createElement(wi,{type:"warning"}," Deprecated "),s&&e.createElement(wi,{type:"primary"}," ","Webhook ",c&&a&&"| "+a.toUpperCase())),p.pathInMiddlePanel&&!s&&e.createElement(kc,{operation:t,inverted:!0}),l&&e.createElement(Np,null,void 0!==n&&e.createElement(ks,{source:n}),i&&e.createElement(ga,{externalDocs:i})),e.createElement(va,{extensions:t.extensions}),e.createElement(op,{securities:t.security}),e.createElement(Pc,{parameters:t.parameters,body:t.requestBody}),e.createElement(Jc,{responses:t.responses}),e.createElement(lp,{callbacks:t.callbacks})),e.createElement(ri,null,!p.pathInMiddlePanel&&!s&&e.createElement(kc,{operation:t}),e.createElement(Ap,{operation:t}),e.createElement(Pp,{operation:t}),e.createElement(jp,{callbacks:t.callbacks})));var u,d}))}));var Fp=Object.defineProperty,Bp=Object.getOwnPropertyDescriptor,Qp=Object.getOwnPropertySymbols,Up=Object.prototype.hasOwnProperty,Wp=Object.prototype.propertyIsEnumerable,Vp=(e,t,r)=>t in e?Fp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r,Hp=(e,t)=>{for(var r in t||(t={}))Up.call(t,r)&&Vp(e,r,t[r]);if(Qp)for(var r of Qp(t))Wp.call(t,r)&&Vp(e,r,t[r]);return e},Jp=(e,t,r,n)=>{for(var o,i=n>1?void 0:n?Bp(t,r):t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=(n?o(t,r,i):o(i))||i);return n&&i&&Fp(t,r,i),i};let Yp=class extends e.Component{render(){const t=this.props.items;return 0===t.length?null:t.map((t=>e.createElement(Zp,{key:t.id,item:t})))}};Yp=Jp([ta.observer],Yp);let Zp=class extends e.Component{render(){const t=this.props.item;let r;const{type:n}=t;switch(n){case"group":r=null;break;case"tag":case"section":r=e.createElement(Xp,Hp({},this.props));break;case"operation":r=e.createElement(Kp,{item:t});break;default:r=e.createElement(Xp,Hp({},this.props))}return e.createElement(e.Fragment,null,r&&e.createElement(ei,{id:t.id,underlined:"operation"===t.type},r),t.items&&e.createElement(Yp,{items:t.items}))}};Zp=Jp([ta.observer],Zp);const Gp=t=>e.createElement(Ko,{compact:!0},t);let Xp=class extends e.Component{render(){const{name:t,description:r,externalDocs:n,level:o}=this.props.item,i=2===o?ai:si;return e.createElement(e.Fragment,null,e.createElement(ni,null,e.createElement(Ko,{compact:!1},e.createElement(i,null,e.createElement(yi,{to:this.props.item.id}),t))),e.createElement(Gl,{source:r||"",htmlWrap:Gp}),n&&e.createElement(ni,null,e.createElement(Ko,null,e.createElement(ga,{externalDocs:n}))))}};Xp=Jp([ta.observer],Xp);let Kp=class extends e.Component{render(){return e.createElement(qp,{operation:this.props.item})}};Kp=Jp([ta.observer],Kp);var eu=Object.defineProperty,tu=Object.defineProperties,ru=(Object.getOwnPropertyDescriptor,Object.getOwnPropertyDescriptors),nu=Object.getOwnPropertySymbols,ou=Object.prototype.hasOwnProperty,iu=Object.prototype.propertyIsEnumerable,su=(e,t,r)=>t in e?eu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let au=class extends e.Component{constructor(){super(...arguments),this.ref=e.createRef(),this.activate=e=>{this.props.onActivate(this.props.item),e.stopPropagation()}}componentDidMount(){this.scrollIntoViewIfActive()}componentDidUpdate(){this.scrollIntoViewIfActive()}scrollIntoViewIfActive(){this.props.item.active&&this.ref.current&&c(this.ref.current)}render(){const{item:t,withoutChildren:r}=this.props;return e.createElement(nc,{onClick:this.activate,depth:t.depth,"data-item-id":t.id},"operation"===t.type?e.createElement(lu,(n=((e,t)=>{for(var r in t||(t={}))ou.call(t,r)&&su(e,r,t[r]);if(nu)for(var r of nu(t))iu.call(t,r)&&su(e,r,t[r]);return e})({},this.props),tu(n,ru({item:t})))):e.createElement(ic,{depth:t.depth,active:t.active,type:t.type,ref:this.ref},e.createElement(sc,{title:t.sidebarLabel},t.sidebarLabel,this.props.children),t.depth>0&&t.items.length>0&&e.createElement(vi,{float:"right",direction:t.expanded?"down":"right"})||null),!r&&t.items&&t.items.length>0&&e.createElement(mu,{expanded:t.expanded,items:t.items,onActivate:this.props.onActivate}));var n}};au=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],au);const lu=(0,ta.observer)((t=>{const{item:r}=t,n=e.createRef(),{showWebhookVerb:o}=e.useContext(ae);return e.useEffect((()=>{t.item.active&&n.current&&c(n.current)}),[t.item.active,n]),e.createElement(ic,{depth:r.depth,active:r.active,deprecated:r.deprecated,ref:n},r.isWebhook?e.createElement(ec,{type:"hook"},o?r.httpVerb:P("webhook")):e.createElement(ec,{type:r.httpVerb},mt(r.httpVerb)),e.createElement(sc,{width:"calc(100% - 38px)"},r.sidebarLabel,t.children))}));var cu=Object.defineProperty,pu=(Object.getOwnPropertyDescriptor,Object.getOwnPropertySymbols),uu=Object.prototype.hasOwnProperty,du=Object.prototype.propertyIsEnumerable,hu=(e,t,r)=>t in e?cu(e,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[t]=r;let mu=class extends e.Component{render(){const{items:t,root:r,className:n}=this.props,o=null==this.props.expanded||this.props.expanded;return e.createElement(rc,((e,t)=>{for(var r in t||(t={}))uu.call(t,r)&&hu(e,r,t[r]);if(pu)for(var r of pu(t))du.call(t,r)&&hu(e,r,t[r]);return e})({className:n,style:this.props.style,expanded:o},r?{role:"navigation"}:{}),t.map(((t,r)=>e.createElement(au,{key:r,item:t,onActivate:this.props.onActivate}))))}};mu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],mu);Object.defineProperty,Object.getOwnPropertyDescriptor;let fu=class extends e.Component{constructor(){super(...arguments),this.activate=e=>{if(e&&e.active&&this.context.menuToggle)return e.expanded?e.collapse():e.expand();this.props.menu.activateAndScroll(e,!0),setTimeout((()=>{this._updateScroll&&this._updateScroll()}))},this.saveScrollUpdate=e=>{this._updateScroll=e}}render(){const t=this.props.menu;return e.createElement(es,{updateFn:this.saveScrollUpdate,className:this.props.className,options:{wheelPropagation:!1}},e.createElement(mu,{items:t.items,onActivate:this.activate,root:!0}),e.createElement(ac,null,e.createElement("a",{target:"_blank",rel:"noopener noreferrer",href:"https://redocly.com/redoc/"},"Documentation Powered by Redocly")))}};fu.contextType=ae,fu=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],fu);const gu=({open:t})=>{const r=t?8:-4;return e.createElement(bu,null,e.createElement(yu,{size:15,style:{transform:`translate(2px, ${r}px) rotate(180deg)`,transition:"transform 0.2s ease"}}),e.createElement(yu,{size:15,style:{transform:`translate(2px, ${0-r}px)`,transition:"transform 0.2s ease"}}))},yu=({size:t=10,className:r="",style:n})=>e.createElement("svg",{className:r,style:n||{},viewBox:"0 0 926.23699 573.74994",version:"1.1",x:"0px",y:"0px",width:t,height:t},e.createElement("g",{transform:"translate(904.92214,-879.1482)"},e.createElement("path",{d:"\n          m -673.67664,1221.6502 -231.2455,-231.24803 55.6165,\n          -55.627 c 30.5891,-30.59485 56.1806,-55.627 56.8701,-55.627 0.6894,\n          0 79.8637,78.60862 175.9427,174.68583 l 174.6892,174.6858 174.6892,\n          -174.6858 c 96.079,-96.07721 175.253196,-174.68583 175.942696,\n          -174.68583 0.6895,0 26.281,25.03215 56.8701,\n          55.627 l 55.6165,55.627 -231.245496,231.24803 c -127.185,127.1864\n          -231.5279,231.248 -231.873,231.248 -0.3451,0 -104.688,\n          -104.0616 -231.873,-231.248 z\n        ",fill:"currentColor"}))),bu=X.div`
  user-select: none;
  width: 20px;
  height: 20px;
  align-self: center;
  ...
  flex-direction: column;
  color: ${e=>e.theme.colors.primary.main};
`;Object.defineProperty,Object.getOwnPropertyDescriptor;let xu;s&&(xu=r(612));const vu=xu&&xu(),wu=X.div`
...
`;let Ou=class extends e.Component{constructor(){super(...arguments),this.state={offsetTop:"0px"},this.toggleNavMenu=()=>{this.props.menu.toggleSidebar()}}componentDidMount(){vu&&vu.add(this.stickyElement),this.setState({offsetTop:this.getScrollYOffset(this.context)})}componentWillUnmount(){vu&&vu.remove(this.stickyElement)}getScrollYOffset(e){let t;return t=void 0!==this.props.scrollYOffset?Q.normalizeScrollYOffset(this.props.scrollYOffset)():e.scrollYOffset(),t+"px"}render(){const t=this.props.menu.sideBarOpened,r=this.state.offsetTop;return e.createElement(e.Fragment,null,e.createElement(wu,{open:t,className:this.props.className,style:{top:r,height:`calc(100vh - ${r})`},ref:e=>{this.stickyElement=e}},this.props.children),!this.context.hideFab&&e.createElement(ku,{onClick:this.toggleNavMenu},e.createElement(gu,{open:t})))}};Ou.contextType=ae,Ou=((e,t,r,n)=>{for(var o,i=t,s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(i)||i);return i})([ta.observer],Ou);const Eu=X.div`
...
`,Ru=X.div`
  padding: 5px 0;
`,ju=X.input.attrs((()=>({className:"search-input"})))`
...
`,Pu=X.i`
  ...
  font-style: normal;
  color: '#666';
`;var Iu=Object.defineProperty,Tu=Object.getOwnPropertyDescriptor;class _u extends e.PureComponent{constructor(e){super(e),this.activeItemRef=null,this.clear=()=>{this.setState({results:[],noResults:!1,term:"",activeItemIdx:-1}),this.props.marker.unmark()},this.handleKeyDown=e=>{if(27===e.keyCode&&this.clear(),40===e.keyCode&&(this.setState({activeItemIdx:Math.min(this.state.activeItemIdx+1,this.state.results.length-1)}),e.preventDefault()),38===e.keyCode&&(this.setState({activeItemIdx:Math.max(0,this.state.activeItemIdx-1)}),e.preventDefault()),13===e.keyCode){const e=this.state.results[this.state.activeItemIdx];if(e){const t=this.props.getItemById(e.meta);t&&this.props.onActivate(t)}}},this.search=e=>{const{minCharacterLengthToInitSearch:t}=this.context,r=e.target.value;r.length<t?this.clearResults(r):this.setState({term:r},(()=>this.searchCallback(this.state.term)))},this.state={results:[],noResults:!1,term:"",activeItemIdx:-1}}clearResults(e){this.setState({results:[],noResults:!1,term:e}),this.props.marker.unmark()}setResults(e,t){this.setState({results:e,noResults:0===e.length}),this.props.marker.mark(t)}searchCallback(e){this.props.search.search(e).then((t=>{this.setResults(t,e)}))}render(){const{activeItemIdx:t}=this.state,r=this.state.results.map((e=>({item:this.props.getItemById(e.meta),score:e.score})));return r.sort(((e,t)=>t.score-e.score)),e.createElement(Ru,{role:"search"},this.state.term&&e.createElement(Pu,{onClick:this.clear},"×"),e.createElement(Cu,null),e.createElement(ju,{value:this.state.term,onKeyDown:this.handleKeyDown,placeholder:"Search...","aria-label":"Search",type:"text",onChange:this.search}),r.length>0&&e.createElement(es,{options:{wheelPropagation:!1}},e.createElement(Au,{"data-role":"search:results"},r.map(((r,n)=>e.createElement(au,{item:Object.create(r.item,{active:{value:n===t}}),onActivate:this.props.onActivate,withoutChildren:!0,key:r.item.id,"data-role":"search:result"}))))),this.state.term&&this.state.noResults?e.createElement(Au,{"data-role":"search:results"},P("noResultsFound")):null)}}_u.contextType=ae,((e,t,r,n)=>{for(var o,i=Tu(t,r),s=e.length-1;s>=0;s--)(o=e[s])&&(i=o(t,r,i)||i);i&&Iu(t,r,i)})([ge.bind,(0,ge.debounce)(400)],_u.prototype,"searchCallback");class Lu extends e.Component{componentDidMount(){this.props.store.onDidMount()}componentWillUnmount(){this.props.store.dispose()}render(){const{store:{spec:t,menu:r,options:n,search:o,marker:i}}=this.props,s=this.props.store;return e.createElement(Z,{theme:n.theme},e.createElement(ui,{value:s},e.createElement(le,{value:n},e.createElement(Eu,{className:"redoc-wrap"},e.createElement(Ou,{menu:r,className:"menu-content"},e.createElement(Ul,{info:t.info}),!n.disableSearch&&e.createElement(_u,{search:o,marker:i,getItemById:r.getItemById,onActivate:r.activateAndScroll})||null,e.createElement(fu,{menu:r})),e.createElement(Su,{className:"api-content"},e.createElement(ql,{store:s}),e.createElement(Yp,{items:r.items})),e.createElement($u,null)))))}}Lu.propTypes={store:se.instanceOf(Tl).isRequired};const Du=function(t){const{spec:n,specUrl:o,options:i={},onLoaded:s}=t,a=F(i.hideLoading,!1),l=new Q(i);if(void 0!==l.nonce)try{r.nc=l.nonce}catch(e){}return e.createElement(te,null,e.createElement(hi,{spec:n,specUrl:o,options:i,onLoaded:s},(({loading:t,store:r})=>t?a?null:e.createElement(ie,{color:l.theme.colors.primary.main}):e.createElement(Lu,{store:r}))))}}(),n}()}));
