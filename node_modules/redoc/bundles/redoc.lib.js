...
`,xa=X(ms)`
  margin: 2px 0;
`;class va extends e.PureComponent{render(){const t=this.props.extensions;return e.createElement(ae.Consumer,null,(r=>e.createElement(e.Fragment,null,r.showExtensions&&Object.keys(t).map((r=>e.createElement(xa,{key:r},e.createElement(na,null," ",r.substring(2),": ")," ",e.createElement(da,null,"string"==typeof t[r]?t[r]:JSON.stringify(t[r]))))))))}}function wa({field:t}){return t.examples?e.createElement(e.Fragment,null,e.createElement(na,null," ",A("examples"),": "),C(t.examples)?t.examples.map(((r,n)=>{const o=Ye(t,r),i=t.in?String(o):JSON.stringify(o);return e.createElement(e.Fragment,{key:n},e.createElement(ua,null,i)," ")})):e.createElement(ka,null,Object.values(t.examples).map(((r,n)=>e.createElement("li",{key:n+r.value},e.createElement(ua,null,Ye(t,r.value))," -"," ",r.summary||r.description))))):null}const ka=X.ul`
  margin-top: 1em;
...
`;class lc extends e.PureComponent{render(){const{name:t,opened:r,className:n,onClick:o,httpVerb:i,deprecated:s}=this.props;return e.createElement(cc,{className:n,onClick:o||void 0},e.createElement(uc,{type:i},mt(i)),e.createElement(vi,{size:"1.5em",direction:r?"down":"right",float:"left"}),e.createElement(pc,{deprecated:s},t),s?e.createElement(wi,{type:"warning"}," ",A("deprecated")," "):null)}}const cc=X.button`
  border: 0;
  width: 100%;
  text-align: left;
  & > * {
...
`,hc=X.div`
  ...
  margin-bottom: 5px;
  margin-top: 5px;
`;class mc extends e.PureComponent{constructor(){super(...arguments),this.selectElement=()=>{Ps.selectElement(this.child)}}render(){const{children:t}=this.props;return e.createElement("div",{ref:e=>this.child=e,onClick:this.selectElement,onFocus:this.selectElement,tabIndex:0,role:"button"},t)}}const fc=X.div`
  cursor: pointer;
  position: relative;
  margin-bottom: 5px;
`,gc=X.span`
